...
import { faTachometerAlt, faBook, faBriefcase, faUsers, faSignOutAlt, faCog, faBell, faSun, faMoon, faHandsHelping, faLongArrowAltRight, faBullhorn, faStream, faPersonRifle, faPersonDress, faPerson, faUserAlt, faPaw, faContactCard } from '@fortawesome/free-solid-svg-icons';
...
const Sidebar = () => {
    ...
    return (
        <aside >
            <div className="bg-white text-gray-700 w-64 min-h-screen p-4 flex flex-col border-r-2 border-customGray sidebar fixed">
                <nav className='pt-10'>
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link to="/forum-list" state={{ user, profile }} className="flex items-center p-2 hover:bg-gray-600 rounded">
